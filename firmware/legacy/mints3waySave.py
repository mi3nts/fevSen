      ...
      try:
        ...
        while True:
          ...
          if elapsedTime > 5:
              ...
              leftImageName    = "threeWayImageDataSets/utdSet7/"+ getImagePathTail(dateTime,'left')
              rightImageName   = "threeWayImageDataSets/utdSet7/"+ getImagePathTail(dateTime,'right')
              thermalImageName = "threeWayImageDataSets/utdSet7/"+ getImagePathTail(dateTime,'thermal')
              kelvinImageName = "threeWayImageDataSets/utdSet7/"+ getImagePathTailMat(dateTime,'kelvin')
              celciusImageName = "threeWayImageDataSets/utdSet7/"+ getImagePathTailMat(dateTime,'celcius')
